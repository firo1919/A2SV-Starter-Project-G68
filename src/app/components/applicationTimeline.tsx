...
export default function ApplicationTimeline() {
	return (
		<div className="p-3 m-4 bg-white shadow-xl rounded-md">
			<h1 className="flex- gap-40 text-lg font-semibold mb-5">Application Timeline</h1>
			...
			<div className="flex gap-2 mt-7">
				<div>
					<img src="./images/loa.png" alt="Application Icon" className="w-10 h-10 object-cover rounded-md" />
				</div>
				<div>
