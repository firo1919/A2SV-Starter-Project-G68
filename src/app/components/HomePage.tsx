...
const HomePage = () => {
	return (
		<div>
			...
			<div className="flex gap-3 md:gap-10 mb-6 px-90 mt-7">
				<Image
					src="/images/google.png"
					alt="Google-Image"
					width={170}
					height={60}
					className="md:w-[200px] md:h-[50px] mr-15"
				/>
				<Image
			...
			<div className="bg-indigo-900 py-10 md:py-20 w-full text-center px-4">
				...
				<p className="text-gray-200 text-sm md:text-base max-w-md mx-auto mb-8">
